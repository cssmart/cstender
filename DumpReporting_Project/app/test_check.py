...
P_CUSTOMER_SITE =''
p_customer_type = ''
p_end_date = '23-Jun-2020'
p_start_date = '10-Jun-2019'
p_customer_id2=1041
...
print(conn_ora,'xxxxxxxxxxxxxxxxxxxxxxxx')
...
line_query =  f'''Select
      ...
      -- AND (d.gl_date) BETWEEN ('{p_start_date}')  AND ('{p_end_date}')
       ...
       ORDER BY 5,4
       '''
b= cursor_ora.execute(line_query)
print(b,'jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj')
excel_write_data = b.fetchall()
print(excel_write_data,'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb')