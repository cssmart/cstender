...
urlpatterns = [
    url(r'^workflow/app/tender/board_add/(?P<pk>\d+)/$', views.add_board_summary, name='addboard'),
    url(r'^workflow/app/tender/board_view/(?P<pk>\d+)/$', views.add_board_from_master, name='board_data'),
    url(r'^workflow/app/tender/board_form/(?P<pk>\d+)/$', views.add_board_detail, name='board'),
    url(r'^workflow/app/tender/module_form/(?P<pk>\d+)/$', views.add_module_list, name='modulelist'),
    ...
    url(r'^workflow/board/(?P<pk>\d+)/$', views.delete_board, name='delete_board'),
    url(r'^workflow/module/(?P<pk>\d+)/$', views.delete_module, name='delete_module'),
    url(r'^workflow/component/(?P<pk>\d+)/$', views.delete_component, name='delete_component'),
    url('workflow/master_boards/', views.master_boards_details, name='master_boards')
]
