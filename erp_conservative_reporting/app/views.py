...
def sales_return_report(request):
    ...
    AND trunc(V.trx_date) between '{business_unit}' and '10-APR-19' and rownum<=1
    ...
    V.CREDIT_MEMO_DATE"""
    output = BytesIO()
    print(output.read(),'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww')
    cursor = conn.cursor()
    ...
    headings = ['Category1', 'Values1','sss','sssssssssss']
    # worksheet.add_table('B3:G7', {'list_data': list_data,
    ...
    #
    #                                            ]})
    # print(worksheet, 'wwwwwwwwwwwwwwww22222222222222222222')
    col = 1
