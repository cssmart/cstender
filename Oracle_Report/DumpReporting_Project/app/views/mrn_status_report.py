...
# db = oracle_db_conn_dbection(r'apps', 'apps1234')
# print(db, 'iiiiiiiiiiiiiiiiiiiiiiiiiiiii')
# cursor = db.cursor()
...
'''
    ...
    # NOT
    # FALSE
    # (organization_id='{inventory_org}' or organization_id is NULL)
    # and (vendor_name='{vender}' or vendor_name is NULL)
    # and (vendor_name='{vender}' or '{vender}' is NULL)
    # and (ge_number='{gate_entry_no}' or '{gate_entry_no}' is NULL)
    # and vendor_name = COALESCE('{vender}', vendor_name)
    # and ge_number = COALESCE('{gate_entry_no}', ge_number)
