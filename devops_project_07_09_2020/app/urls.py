...
urlpatterns = [
    ...
    path('reinitialize_approval_<int:pk>', views.Reinitialize_Approval_Workflow, name='Reinitialize_Approval_Workflow'),
    ...
    path('notification_<int:pk>_<int:t_id>', views.approval_notification_task_action_view, name='approval_notification_task_action_view'),
    path('parent_task_<int:pk>', views.parent_task_form_view, name='parent_task_view'),
    path('notification_view_<int:pk>', views.notification_id_view, name='notification_id_view'),
    ...
    path('forwarded_note_<int:pk>', views.forwarded_note_view,name='forwarded_note_view'),
    ...
    path('task_edit_<int:pk>', views.task_summary_edit, name="task_summary_edit"),
