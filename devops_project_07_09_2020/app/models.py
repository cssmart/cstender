...
class PROJECT(models.Model):
    ...
    task_creation = models.CharField(choices=[('self','Anyone can create the task'),('owner','Only owner can create the task')],max_length=100, blank=True)
...
class TASK(models.Model):
    ...
    status = models.CharField(choices=[('new','New'),('in_progress','In Progress'),('closed','Closed')], max_length=50, blank=True)
...
class NOTIFICATIONS(models.Model):
    ...
    notification_category = models.CharField(max_length=100, blank=True)
    person_name = models.ForeignKey(PEOPLE, on_delete=models.CASCADE, related_name="person_name",blank=True, null=True)
    notification_text = models.CharField(max_length=500, blank=True)
    attribute_1 = models.CharField(max_length=500, blank=True)
    attribute_2 = models.CharField(max_length=500, blank=True)
    # person_id = models.CharField(max_length=500, blank=True)
